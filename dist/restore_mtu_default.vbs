...
psCommand = "powershell -WindowStyle Hidden -Command ""Add-Type -AssemblyName System.Windows.Forms; " & _
            ...
            "if (-not $adapter) { " & _
            "  [System.Windows.Forms.MessageBox]::Show('No active network adapter found.', 'MTU Reset'); exit " & _
            "}; " & _
            ...
            "if ($currentMtu -eq '1500') { " & _
            "  [System.Windows.Forms.MessageBox]::Show('MTU is already set to default (1500).', 'MTU Reset') " & _
            "} else { " & _
            "  netsh interface ipv4 set subinterface ($adapter.Name) mtu=1500 store=persistent; " & _
            "  [System.Windows.Forms.MessageBox]::Show('MTU has been restored to 1500.', 'MTU Reset') " & _
            "}"""
